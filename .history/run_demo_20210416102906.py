...
cap.set(cv2.CAP_PROP_POS_FRAMES, args.set_frame)
...
known_face_names, known_face_encodings = img_floder(args.pic_dir, retinaface, dst_pts, model)
print('发现以下人物:', ' ，'.join(known_face_names))

pbar = tqdm(total=cap.get(cv2.CAP_PROP_FRAME_COUNT)-args.set_frame)
